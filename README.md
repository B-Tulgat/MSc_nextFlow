...
Note: Reference file is installed to the `reference` directory itself for EPI2ME workflow (or copy/move the downloaded reference file) but for our custom workflow proceed with the above download command.
